...
## About me
  ...
  - 🌱 JS, HTML, CSS, Cibersecurity Fundamentals. I’m currently re-skilling learning IA, n8n and Python with IA 
...
## [Gemini Glow Dark - Extension: VS Code Theme](https://marketplace.visualstudio.com/items?itemName=GEMMA-CLAVERO-DEL-MORAL.gemini-glow-dark)

<div align="center">
<img src="https://code.visualstudio.com/assets/images/code-stable.png" width="100px" alt="Visual Studio Code Logo">
 &emsp;&emsp;&emsp;
<img src="https://raw.githubusercontent.com/GemmaClaverodelMoral/gemini-glow-dark/main/icon.png" width="110px" alt="Gemini Glow Dark Logo">
</div>

A high-contrast dark theme for Visual Studio Code, meticulously designed to replicate the vibrant and clear color palette of the code generated by Gemini, with a special focus on Python.

### What does this project contain?

  - A complete, publish-ready theme for the VS Code Marketplace.
  - A carefully selected color palette to maximize legibility and reduce eye strain.
  - Specific syntax highlighting for Python inspired by the Gemini interface.
  - Recommended font configuration (`Inconsolata`) and settings for a 100% faithful experience.

### What was used?

  - VS Code Theme JSON specification
  - `vsce` (Visual Studio Code Extensions) for packaging and publishing
...
<div align = "center">  
<img src="[https://github.com/GemmaClaverodelMoral/comparativa-useState-react.component-useRedux/blob/main/public/Manejos-del-estado-React.png](https://github.com/GemmaClaverodelMoral/comparativa-useState-react.component-useRedux/blob/main/public/Manejos-del-estado-React.png)" width="400px">
</div>
